...
abstract class Table
{
    ...
    public function __construct() {
        ...
        // Setup upgrade the database schema
        $this->set_upgrade();
    ...
    /**
     * set upgrade schema this database table
     *
     * @since 1.1.0
     */
    protected abstract function set_upgrade();
    ...
    private function upgrade()
    {
        if ($this->upgrade_schema){
            ...
            $query   = "ALTER TABLE {$this->table_name} {$this->upgrade_schema};";
     ...
     *
     * @return bool|string Sanitized database table name
     * @since 1.3.0
     *
     */
